...
<<<<<<< Updated upstream
  ...
  return (
    <div>
      <Header />
      <h1 className='text-[#00afaf] text-center mt-4 text-[24px]'>Book Services</h1>
      <div className='w-48 h-[2px] bg-[#00afaf] mt-2 mx-auto mb-6'></div>
      <div className='w-full h-[2px] bg-gray-300'></div>
      <h1 className='ml-32 mt-4 text-[24px]'>Electricians:</h1>
      <div className='flex justify-between w-[80%] mx-auto mt-4'>
        <div className='w-[280px] h-[380px] rounded-[40px] shadow-xl border-[7px] border-white hover:border-[#00afaf]'>
          ...
          <div className='flex justify-between w-[90%] mx-auto'>
            <div className='flex'>
              <h3 style={{ transform: 'translateY(-25px)', fontSize: '20px' }}>5</h3>
      ...
      <h1 className='ml-32 my-4 text-[24px]'>Plumbers:</h1>
      <div className='flex justify-between w-[80%] mx-auto mt-4'>
        {plumbers.map((person) => (
          <Card
            reviews={person.reviews}
      ...
      <div className='w-full h-[2px] bg-gray-300 mt-16'></div>
      <h1 className='ml-32 my-4 text-[24px]'>painters:</h1>
